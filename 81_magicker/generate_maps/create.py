...
from generate_maps.basic import create_variable_plot
from generate_maps.utils.extract_names import extract_output_names
...
def create_maps(model_run, df, output_directory, color_configuration, custom_font, start_date, end_date, selected_date):
    ...
    variables_and_settings = [
        ("Value", "najvišja temperatura zraka", "temperatura [°C]", cmap_temperature,
